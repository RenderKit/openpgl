...
struct FieldConfig
{
     ...
     */
    void Init(const PGL_SPATIAL_STRUCTURE_TYPE spatialType, const PGL_DIRECTIONAL_DISTRIBUTION_TYPE directionalType, const bool deterministic = true, const size_t maxSamplesPerLeaf = 32000);
