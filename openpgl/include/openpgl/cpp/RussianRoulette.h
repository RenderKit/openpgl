...
namespace util
{
     ...
     * @param maxSurvivalProbability The maximum returned survival probability (default = 1.0).
     */
    OPENPGL_INLINE float GuidedRussianRoulette(const pgl_vec3f &throughput, const pgl_vec3f &adjoint, const pgl_vec3f &contributionEstimate, const float minSurvivalProbability = 0.0f, const float maxSurvivalProbability = 1.f)
    {
