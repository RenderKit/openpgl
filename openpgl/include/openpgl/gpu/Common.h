...
namespace cpu {
    ...
    union Vector2
    {
        ...
        OPENPGL_GPU_CALLABLE inline float& operator[](std::size_t idx)       { return data[idx]; }
        OPENPGL_GPU_CALLABLE inline const float& operator[](std::size_t idx) const { return data[idx]; }
