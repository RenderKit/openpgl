...
OPENPGL_CORE_INTERFACE pgl_vec3f pglVolumeSamplingDistributionIncomingRadiance(PGLVolumeSamplingDistribution volumeSamplingDistribution, pgl_vec3f direction, const bool directLightMIS);
...
OPENPGL_CORE_INTERFACE pgl_vec3f pglVolumeSamplingDistributionInscatteredRadiance(PGLVolumeSamplingDistribution volumeSamplingDistribution, pgl_vec3f direction, float g, const bool directLightMIS);
